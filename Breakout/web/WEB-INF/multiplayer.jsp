<%-- 
    ...
    Created on : 18-dec-2017, 10:06:15
    Author     : massi
--%>

<%@ include file="gameEnvironmentHeader.jspf"%>
<div id='scores'>
       <p>Player1:<em id='player1score'>0</em></p>
        <p>Player2:<em id='player2score'>0</em></p>
        <div id='timer'>
        ...
        <div id='overlay'>
        <div id='loader'><img src="assets/images/Spinner.svg" alt="loadingicon"></div>;
        </div>
...
<script src="assets/js/scriptmp.js"></script>
